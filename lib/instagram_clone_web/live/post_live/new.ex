defmodule InstagramCloneWeb.PostLive.New do
  ...
  alias InstagramClone.{Posts, Posts.Post}
  ...
  def mount(_params, session, socket) do
    ...
    {:ok,
     ...
     |> allow_upload(:photo_url, accept: @extension_whitelist, max_file_size: 30_000_000)}
  end

  @impl true
  def handle_event("validate", %{"post" => post_params}, socket) do
    changeset = Posts.change_post(%Post{}, post_params) |> Map.put(:action, :validate)

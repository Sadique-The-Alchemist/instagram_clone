defmodule InstagramCloneWeb.UserLive.FollowComponent do
  ...
  defp get_follow_btn_styles?(name) when name == "Follow" do
    "py-1 px-2 mx-5 text-red-500 border-2 rounded font-semibold hover:bg-gray-50 focus:outline-none"
  end

  defp get_follow_btn_styles?(name) when name == "Unollow" do
    "py-1 px-5 mx-5 border-none shadow text-gray-50 rounded hover:bg-light-blue-600 bg-light-blue-500 focus:outline-none"
  end
end
